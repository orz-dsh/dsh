...
func BuildTemplate(config map[string]interface{}, funcs template.FuncMap, templateSourcePath string, templateLibSourcePaths []string, outputTargetPath string) error {
	...
	if err != nil {
		return dsh_utils.WrapError(err, "template parse failed", map[string]interface{}{
