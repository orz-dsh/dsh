...
func newProfileProjectItemSettingInspection(name string, dir string, match string, dependency *ProjectDependencySettingInspection, resource *ProjectResourceSettingInspection) *ProfileProjectItemSettingInspection {
